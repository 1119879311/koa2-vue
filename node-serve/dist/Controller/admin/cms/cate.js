...
let index = (_dec = Controller("/cate"), _dec2 = GET("/"), _dec3 = POST("/add"), _dec4 = userAuth(), _dec5 = roleAuth(), _dec6 = POST("/swtich"), _dec7 = userAuth(), _dec8 = roleAuth(), _dec9 = POST("/update"), _dec10 = userAuth(), _dec11 = roleAuth(), _dec12 = POST("/delete"), _dec13 = userAuth(), _dec14 = roleAuth(), _dec(_class = (_class2 = class index {
